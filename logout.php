		...
		<div class="grid-container">
			...
			<div class="theContent">
				...
				if (!empty($_SESSION["uname"])) {
					echo "<img src=\"./img/logout2.png\" alt=\"Logout\" class=\"logout\">";
					echo "<br><br>Ciao ".$_SESSION["uname"]." ! Per effettuare il logout clicca <a href=\"disconnessione.php\">QUI</a>.";}
				else 
					echo "<p>Non hai ancora effettuato il login</p>"; 
				?>
			</div>
			<div class="theFooter">
